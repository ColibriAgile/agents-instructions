...
5. Grave somente a TechSpec. Reporte decisões, lacunas e tasks invalidadas por atualização. No fluxo orquestrado, devolva para elaboração do plano e HIL técnico conjunto. Em uso avulso, faça a pausa de sessão desse protocolo com `sdd-planejar-tasks` como próximo passo; entradas de mapa de código vindas da medição do terreno valem um snapshot.
