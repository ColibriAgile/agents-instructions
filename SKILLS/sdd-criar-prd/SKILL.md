...
4. Grave somente o PRD e reporte caminho, pendências e obrigações adicionadas, alteradas ou removidas. Aponte derivados a revalidar sem editá-los. No fluxo orquestrado, devolva o artefato para HIL de produto; autorização anterior vale para o escopo que ela cobre. Em uso avulso, faça a pausa de sessão desse protocolo com `sdd-criar-techspec` como próximo passo.
