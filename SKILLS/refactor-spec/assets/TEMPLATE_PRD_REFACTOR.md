...
> Em refactor, "requisito" não é comportamento novo — é comportamento existente que não pode mudar. Cada linha vira insumo para os test cases da techspec e, depois, para as tarefas geradas pela skill `criar-tasks`.
