...
4. Rastreie callers, efeitos, contratos, erros e riscos nos caminhos alterados; consulte regras/skills pertinentes. Confira comandos e resultados; reaproveite execução comprovada do mesmo código/configuração/ambiente, executando verificações faltantes ou invalidadas.
   Rode todos os comandos do perfil de qualidade da TechSpec sobre o conjunto revisável, bloqueantes e ressalvas. Conformidade com aceite e testes não substitui o perfil: um diff que atende todas as obrigações e ainda carrega hit bloqueante não justificado tem defeito. TechSpec sem perfil de qualidade é lacuna registrada nas limitações, não perfil vazio.
