...
| Relatório de `architectural-analysis` | `sdd-planejar-auditoria` | uma pasta por frente com `prd.md`, `techspec.md`, `tasks.md`; mapa de destinos em `.audits/` |
